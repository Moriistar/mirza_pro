...
if(!file_exists($configDirectory) || !file_exists($tablesDirectory)) {
    ...
    $ERROR[] = "فایل های پروژه را مجددا دانلود و بارگذاری کنید (<a href='https://github.com/Moriistar/mirza_pro/releases/'>‎🌐 Github</a>)";
}
if(phpversion() < 8.2){
...
<body>
    <div class="container">
        ...
        <footer>
            <p>MirzabotPro Installer , Made by ♥️ | <a href="https://github.com/Moriistar/mirza_pro/releases/">Github</a> | <a href="https://t.me/+COMDGvsapck0NzE0">Telegram</a> | &copy; <?php echo date('Y'); ?></p>
        </footer>
    </div>
        <script>
